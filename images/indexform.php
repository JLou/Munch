  ...
  <section id="registercontainer">
	...
	<table>
	  <tr>
	    ...
	    <td>
	      <input method="post" type="checkbox" id="restaurant" name="restaurant"/>
	    </td>
	  </tr>
	  <tr>
	...
	<tr>
	  ...
	  <td><input type="text" id="telprefix" value="+ 27" disabled="disabled" /><input type="text" id="tel" name="tel" /></td>
