     <form method="post" name="register" id="restaurantform" action="signup.php?restau=true">
      <fieldset>
      <legend>Restaurant Registration</legend>
...
<input type="text" id="tel" name="tel" /></td>
	  <td class="third" id="ptel">ex: 812345678</td>
	</tr>
	<tr>
	...
	<tr>
	  ...
	  <td class="third" id="tos"></td>
        ...
        <tr id="last"><td colspan="3"><input type="submit" class="button" class="pointer" value="register"/></td></tr>
